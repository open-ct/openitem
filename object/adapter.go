...
func (a *Adapter) createTable() {
	err := a.engine.Sync2(new(Dataset), new(Project), new(Audit), new(FileItem), new(Step), new(Submit), new(TempQuestion), new(FinalQuestion), new(TempTestpaper), new(FinalTestpaper))
	if err != nil {
		panic(err)
	}
}
