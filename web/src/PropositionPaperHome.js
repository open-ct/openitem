...
import {Button, Card, Col, Modal, Pagination, Radio, Row, Space, Spin, Table} from "antd";
import UpLoadQuestionModal from "./UpLoadQuestionModal";
import PropositionPaperIcon from "./proposition-paper-icon.png";
...
export default class PropositionPaperHome extends Component {
    ...
    getQuestionRecord = (Id) => {
      ...
      // });
      // request({
      //     url:baseURL1+`/qbank/question/trace/${Id}`,
    ...
    getQuestionListInfo = () => {
      ...
      // });
      // request({
      //     url:baseURL1+"/qbank/query/t_question",
    ...
    getUserQuestionList = () => {
      ...
      // });
      // request({
      //     url:baseURL1+`/qbank/question/user_t/${store.getState().userInfo.Id}`,
    ...
    getUserTestpaperList = () => {
      ...
      // });
      // request({
      //     url:baseURL1+`/qbank/testpaper/user_t/${store.getState().userInfo.Id}`,
