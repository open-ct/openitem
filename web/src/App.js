  ...
  renderFooter() {
    ...
    return (
      <Footer id="footer" style={
        ...
        Made with <span style={{color: 'rgb(255, 255, 255)'}}>❤️</span> by <a style={{fontWeight: "bold", color: "black"}} target="_blank" href="https://item.open-ct.com">OpenItem</a>, { Setting.isMobile() ? "Mobile" : "Desktop" } View
      </Footer>
    )
  }
