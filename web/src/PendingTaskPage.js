  ...
  constructor(props) {
    ...
    this.state = {
      ...
      seekProjectManagement = (state) => {
        this.props.history.push(`/project-management/${state.project_id}/${state.role}`);
      }
      ...
      //     loadingState:true
      //   })
      //   request({ method:'GET', url:baseURL+`/review/proj/user/${store.getState().userInfo.Id}`}).then(res=>{
          ...
          <Layout className="pending-tasks-page" data-component="pending-tasks-page">
            ...
            <Footer>
              ...
              <Modal
                ...
                //       createLoading:true
                //     })
                //     request({ method:'POST', url:baseURL+"/review/proj/template",data}).then(res=>{
